...
trainImagesPath = '../../../datasets/data/cookingtrainimages.npy'
trainMasksPath = '../../../datasets/data/cookingtrainmask.npy'
trainSaliencyImagesPath = '../../../datasets/data/cookingtrainsaliencyimages.npy'
